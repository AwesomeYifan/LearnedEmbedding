...
import mtree.tests.fixtures.Traces.generator as Traces.generator
...
class Test(unittest.TestCase):
	...
	def testRandom(self):
		...
		if os.path.isfile(random_test_path):
			...
			options = Traces.generator.Options(actions=500, dimensions=3, remove_chance=0.2)
			fixture = Traces.generator.generate_test_data(options)
			f = file(random_test_path, 'w')
			stdout_bkp = sys.stdout
			sys.stdout = f
			try:
				print "# Test case generated by testRandom()."
				Traces.generator.print_test_data(fixture, options)
			finally:
