...
TRAIN_CSV = "../../Data/data/TripletData.csv"
...
triplet_train_dataset = TripletDataset(X_train, Y_train)  # Returns pairs of images and target same/different
triplet_test_dataset = TripletDataset(X_validation, Y_validation)
...
log_interval = 100
fit(triplet_train_loader, triplet_test_loader, model, loss_fn, optimizer, scheduler, n_epoch, cuda, log_interval)

for i in range(num_clusters):
    TEST_CSV = "../../Data/data/class-" + str(i) + ".csv"
    with open(TEST_CSV) as csv_file:
        with open('../../Data/data/triplet-reducedVectors-' + str(i) + ".csv", 'w') as writeFile:
